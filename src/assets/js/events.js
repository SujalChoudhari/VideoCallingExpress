...
window.addEventListener('load', () => {
    ...
    document.getElementById('local').addEventListener('picture-in-picture', () => {
        if (!document.pictureInPictureElement) {
            document.getElementById('local').requestPictureInPicture()
                .then(() => {
                    document.getElementById("local").classList.toggle("mirror-mode")
                })
                .catch(error => {
    ...
    const draggableElements = document.querySelectorAll('.local-video');
